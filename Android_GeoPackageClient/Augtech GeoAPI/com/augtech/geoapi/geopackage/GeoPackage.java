...
public class GeoPackage {
	...
	public GeoPackage(ISQLDatabase sqlDB, boolean overwrite) {
		...
		sqlTypeMap.put("unknown", JavaType.BYTE_ARR);
		...
		sqlTypeMap.put("text(11)", JavaType.STRING);
		sqlTypeMap.put("text(20)", JavaType.STRING);
		sqlTypeMap.put("text(48)", JavaType.STRING);
		sqlTypeMap.put("text(16)", JavaType.STRING);
	...
	public List<SimpleFeature> getFeatures(final String tableName, final BoundingBox bbox, boolean includeIntersect, 
		...
		sqlStmt.append("SELECT * FROM [").append(tableName).append("] WHERE ogc_fid IN(");
