...
public class Gpkgteste {
	...
	public static final int TEST_NDBY = 6;
	 ...
	 * @param overwrite
	 */
	public Gpkgteste(ISQLDatabase database, boolean overwrite) {
	...
	public boolean runQeryTestCase(int testCase, ITestFeedback fb) throws Exception {
		...
		case TEST_NDBY: 
			...
			bbox = new BoundingBoxImpl(11, 13, 47, 49, crs);
