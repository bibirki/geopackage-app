...
public class GMLFilterFeature extends XMLFilterImpl implements GMLHandlerJTS {
	...
	private InlineHandlerr inlineHandler;
    ...
    public GMLFilterFeature(InlineHandlerr inlineHandler) {
    	super();
    ...
    public void startElement(String namespaceURI, String localName,
        ...
        if (isFeatureMember(localName)) {
            ...
            inlineHandler.startElement(namespaceURI, localName, qName, atts);
        }
    }
    ...
    private void handleCharacters() throws SAXException{
        ...
        if (insideAttribute && !rawAttribute.equals("")) {
           //LOGGER.info("raw att = " + rawAttribute);
            ...
            inlineHandler.characters(rawAttribute.toCharArray(), 0, rawAttribute.length());
    ...
    public void endElement(String namespaceURI, String localName, String qName)
        ...
        if (isFeatureMember(localName)) {
            ...
            inlineHandler.endElement(namespaceURI, localName, qName);
