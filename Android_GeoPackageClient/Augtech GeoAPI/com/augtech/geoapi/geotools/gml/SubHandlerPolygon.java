 ...
 * @source $URL: http://svn.osgeo.org/geotools/trunk/modules/library/main/src/main/java/org/geotools/gml/SubHandlerPolygon.java $
...
public class SubHandlerPolygon extends SubHandler {
    ...
    public void subGeometry(String message, int type) {
                ...
                if (location == INNER_BOUNDARY) {
                    ...
                    if (cga.isCCW(points)) {
                        ...
                        try {
                        	...
                        	System.out.println("Caught Topology exception in "
                                + "GMLPolygonHandler");
                            outerBoundary = null;
                        }
                    }
        ...
        } else if (message.equals("outerBoundaryIs") || message.equals("exterior")) {
            //  or, if we are getting notice of an inner/outer boundary marker,
            // set current location appropriately
            location = OUTER_BOUNDARY;
        } else if (message.equals("innerBoundaryIs") || message.equals("interior")) {
